...
% in \href and gets the blue colorlinks treatment. providecommand
% first because not every bibliography style defines \doi.
\providecommand{\doi}[1]{\href{https://doi.org/#1}{doi:~\detokenize{#1}}}
\renewcommand{\doi}[1]{\href{https://doi.org/#1}{doi:~\detokenize{#1}}}

% Author byline: name + location only (never employer). Injected via
% AtBeginDocument so it overrides the R Journal default author block.
\AtBeginDocument{
  \author{Charles Coverdale\thanks{Email: \href{mailto:charles.f.coverdale@gmail.com}{charles.f.coverdale@gmail.com}. Package repository: \href{https://github.com/charlescoverdale/aieconindex}{github.com/charlescoverdale/aieconindex}.}\\ London, United Kingdom}
}
\usepackage{longtable}
